...
// 属性 property 的原类，对 YYClassPropertyInfo 的进一步封装
...
- (instancetype)initWithClass:(Class)cls {
    ...
    // 递归继承链上所有对象（除了 NSObject 和 NSProxy），并创建对应的 _YYModelPropertyMeta 对象
...
// 对于 Number 类型的属性进行转换
// 直接使用 runtime 的 objc_msgSend 来调用 getter 方法来提高访问速度
...
// json 转 NSDictionary
// NSDictionary 中的 value 要转换为指定类的 model
