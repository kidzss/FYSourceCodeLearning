...
// 将一个 UIKit 世界的对象 NSObject 转换成 ReactiveCocoa 中的 RACSignal
...
- (RACSignal *)bind:(RACStreamBindBlock (^)(void))block {
	...
	return [[RACSignal createSignal:^(id<RACSubscriber> subscriber) {
		...
		@autoreleasepool {
            ...
            // subscribeNext 订阅当前信号
            // 将当前信号“解包”出 NSObject 对象
			RACDisposable *bindingDisposable = [self subscribeNext:^(id x) {
                ...
                // 调用 bindingBlock（用户传入），将 NSObjec 转换为 signal
...
// 订阅一个信号的过程中，会创建一个 RACSubscriber 类
